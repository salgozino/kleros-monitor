...
// where ctx = { dispute, round } identifies the single draw the prompt is for.
//
...
/** @type {Record<string, { name: string, renderSkill: (config: object, ctx: { dispute: string|number, round: string|number }) => string }>} */
const REGISTRY = {
 ...
 *
 * @param {string} name
 * @returns {{ name: string, renderSkill: (config: object, ctx: { dispute: string|number, round: string|number }) => string }}
 */
